    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                contributions. We suggest a donation of about 500 BAHT per day,
                per person as it covers all food, accomodations, electricity
                expenses... Sathu!
            </p>
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">Write your name and the date.</li>
                <li class="list-group-item">
            ...
            <div class="card-body w-75 mx-auto">
                <figure class="figure border rounded p-3">
                    <img
                        ...
                        alt="donation box"
                    />
                    <figcaption class="figure-caption">Donation box</figcaption>
                </figure>
            </div>
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">Account number: 982 91 00 855</li>
                <li class="list-group-item">
